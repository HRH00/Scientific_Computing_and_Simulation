...
public class LBMThreaded extends Thread {
    ...
    final static int blockSizeY =  NY/P;
 ...
 //   public CyclicBarrier(P);
    ...
    public void run() {
       ...
       int startSizeX = me*blockSizeX;
       int endSizeX = startSizeX+blockSizeX;

       int startSizeY = me*blockSizeY;
       int endSizeY = startSizeY+blockSizeY;
        for(int time = 0 ; time < NITER ; time++) {
            if (me==0){
                time1 = System.currentTimeMillis();
            }
            // Calculate macroscopic density and velocity
            for(int i = startSizeX ; i < endSizeX ; i++) {
                for(int j = endSizeY; j < endSizeY ; j++) {
    ...
    static class Display extends JPanel {
        ...
        Display() {
            ...
            JFrame frame = new JFrame("Parallel LBM");
