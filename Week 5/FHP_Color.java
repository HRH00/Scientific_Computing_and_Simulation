...
public class FHP_Color {
    final static int NX = 1900, NY =  1000;  // Lattice dimensions, must be less than 2000
    final static int q = 6 ;  // population
    final static int NITER = 2000 ;
    final static int DELAY = 40 ;
    final static double DENSITY = 0 ;  // initial state, between 0 and 1.0.
    ...
    public static void main(String args []) throws Exception {
      ...
      for(int i = 0; i < NX ; i++) { 
       ...
       centerX = NX/2;  // X-coordinate of the circle center
            ...
            for(int i = 0 ; i < NX ; i++) {
                for(int j = 0 ; j < NY ; j++) {
                    ...
                    if (partical_Density<25){
                        ...
                        int multiplier = 255/150;

                        g.setColor(new Color(255-(partical_Density*multiplier),0,0));
