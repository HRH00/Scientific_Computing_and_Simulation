...
Increasing the initial values of 't'/'tend' causes the speed of the orbit to slow dramatically \autoref{fig:W10-5}.
\begin{figure}[H] 
    \centering
...
%\begin{figure}[H] 
%    \centering
%    \includegraphics[width=0.49\columnwidth]{Figures/Week 8/}
